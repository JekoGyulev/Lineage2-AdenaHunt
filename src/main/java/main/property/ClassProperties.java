...
public class ClassProperties {
    ...
    public ClassDetails getDetailsClassByPlayerClass(PlayerClass playerClass) {

        ClassDetails classDetails = this.classes
                .stream()
                .filter(clazz -> clazz.getPlayerClass().equals(playerClass))
                .findFirst()
                .orElseThrow(() -> new RuntimeException("Class was not found"));
